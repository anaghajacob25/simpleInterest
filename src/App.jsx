  ...
  return (
    ...
    <div style={{height:'100vh'}} className='bg-dark d-flex justify-content-center align-items-center'>
      <div className='bg-light p-5 rounded' style={{width:'500px'}}>
        ...
        <div style={{height:'130px'}} className='bg-warning rounded mt-3 d-flex justify-content-center align-items-center flex-column'>
            <h1>$ {interest}</h1>
            ...
            <Button variant="outlined" onClick={handleReset} style={{height:'60px',width:'190px'}}>Reset</Button>
            </div>
